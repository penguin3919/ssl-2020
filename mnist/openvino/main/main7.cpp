...
int main(int argc, char* argv[]){
	...
	size_t height=0;
	size_t width=0;
	std::vector<std::shared_ptr<unsigned char>> imagedata(10000);
	...
	{
		imagedata[d].reset(new unsigned char[size], std::default_delete<unsigned char[]>());
	}
	...
	{
		std::cout<<label_data[ddd]<<std::endl;
	}
	*/	
